...
actions = [
    ...
    "qui jongle avec des claçons",
    "qui se dispute avec son miroir",
    "qui mange un gâteau géant",
    "qui saute en parachute avec un parapluie",
    "qui essaie de voler avec des ballons",
    ...
    "qui se cache dans un frigo",
    "qui essaie de parler à une plante",
    "qui jongle avec des téléphones",
    "qui essaie de dompter une vague",
    ...
    "qui essaie d'attraper un éclair",
