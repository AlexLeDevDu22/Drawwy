...
character = pygame.transform.scale(character, (int(
    screen_width * 0.2), int(screen_height * 0.2)))  # Redimensionner le personnage
...
def cinematic():
    ...
    quit_text = font.render(
        'Appuyez sur Q pour quitter', True, (255, 255, 255))
