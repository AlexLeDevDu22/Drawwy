...
def UIdrawer(phrase):
    ...
    ecran.fill(BEIGE)
    zones = [
        (20 / 100 * largeur, 4 / 100 * hauteur, 60 / 100 *
         largeur, 91 / 100 * hauteur),  # Zone de dessin
        (1 / 100 * largeur, 4 / 100 * hauteur, 18 / 100 *
         largeur, 70 / 100 * hauteur),   # Liste personnes
        (1 / 100 * largeur, 75 / 100 * hauteur, 18 / 100 *
         largeur, 20 / 100 * hauteur),   # Mot à deviner
        (81 / 100 * largeur, 4 / 100 * hauteur, 18 /
         100 * largeur, 25 / 100 * hauteur),  # Couleurs
        (81 / 100 * largeur, 30.83 / 100 * hauteur, 18 / 100 *
         largeur, 8.33 / 100 * hauteur),  # Style de stylo
        (81 / 100 * largeur, 40.83 / 100 * hauteur, 18 /
         100 * largeur, 54.5 / 100 * hauteur),  # Chat
        (1 / 100 * largeur, 4 / 100 * hauteur, 18 / 100 *
         largeur, 7 / 100 * hauteur),  # Texte joueurs
        (1 / 100 * largeur, 11 / 100 * hauteur, 18 /
         100 * largeur, 7 / 100 * hauteur),  # p1
        (1 / 100 * largeur, 18 / 100 * hauteur, 18 /
         100 * largeur, 7.1 / 100 * hauteur),  # p2
        (1 / 100 * largeur, 25 / 100 * hauteur, 18 /
         100 * largeur, 7 / 100 * hauteur),  # p3
        (1 / 100 * largeur, 32 / 100 * hauteur, 18 /
         100 * largeur, 7 / 100 * hauteur),  # p4
        (1 / 100 * largeur, 39 / 100 * hauteur, 18 /
         100 * largeur, 7 / 100 * hauteur),  # p5
        (1 / 100 * largeur, 46 / 100 * hauteur, 18 /
         100 * largeur, 7 / 100 * hauteur),  # p6
        (1 / 100 * largeur, 53 / 100 * hauteur, 18 /
         100 * largeur, 7.1 / 100 * hauteur),  # p7
        (1 / 100 * largeur, 60 / 100 * hauteur, 18 /
         100 * largeur, 7 / 100 * hauteur),  # p8
        (1 / 100 * largeur, 67 / 100 * hauteur, 18 /
         100 * largeur, 7 / 100 * hauteur),  # p9
    ...
    while running:
        ...
        police = pygame.font.Font("assets/PermanentMarker.ttf", 20)
        ...
        if len(phrase) <= 24:
            ...
            police = pygame.font.Font("assets/PermanentMarker.ttf", long)
            ...
            image_texte2 = police.render(
                phrase[taille3parties:taille3parties * 2], 1, (0, 0, 0))
            ecran.blit(image_texte2, (3 / 100 * largeur, 84 / 100 * hauteur))
            image_texte3 = police.render(
                phrase[taille3parties * 2:], 1, (0, 0, 0))
